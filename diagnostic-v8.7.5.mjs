#!/usr/bin/env node
/**
 * v8.7.5 Diagnostic: 1-match detailed analysis
 * Tracks zone occupancy, maxBallAX, shots, goals, and Phase B diagnostic metrics
 */
...
function runDiagnostic() {
  ...
  console.log('=== v8.7.5 DIAGNOSTIC (1 MATCH) ===\n');
  ...
  console.log(`  phaseBEligibleFrames: Blue ${state.stats.phaseBEligibleFrames.blue}, Red ${state.stats.phaseBEligibleFrames.red}`);
  console.log(`  phaseBShots: Blue ${state.stats.phaseBShots.blue}, Red ${state.stats.phaseBShots.red}`);
  console.log(`  phaseBBlockedPassCount: Blue ${state.stats.phaseBBlockedPassCount.blue}, Red ${state.stats.phaseBBlockedPassCount.red}`);
  console.log(`  forcedShotsFromBlocked: Blue ${state.stats.forcedShotsFromBlocked.blue}, Red ${state.stats.forcedShotsFromBlocked.red}`);
  console.log(`\n✓ Diagnostic complete`);
...
writeFileSync('/home/ubuntu/v8.7.5-diagnostic.json', JSON.stringify(result, null, 2));
console.log(`\n✓ Result saved to /home/ubuntu/v8.7.5-diagnostic.json`);
